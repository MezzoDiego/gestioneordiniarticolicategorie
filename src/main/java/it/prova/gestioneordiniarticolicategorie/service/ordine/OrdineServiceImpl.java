...
public class OrdineServiceImpl implements OrdineService {
	...
	@Override
	public List<String> trovaIndirizziDiOrdiniContenentiStringaNelNumeroSerialeDegliArticoli(String input)
			throws Exception {
		// questo è come una connection
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
		...
		try {
			...
			// eseguo quello che realmente devo fare
			return ordineDAO.findAllIndirizziOfOrdiniHavingAStringInTheSerialNumberOfHisArticoli(input);
