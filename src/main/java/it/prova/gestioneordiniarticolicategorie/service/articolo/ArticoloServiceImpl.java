...
public class ArticoloServiceImpl implements ArticoloService {
	...
	public void rimuoviArticoloDallaTabellaDiJoin(Long idArticolo) throws Exception {
		...
		try {
			...
			// eseguo quello che realmente devo fare
			articoloDAO.deleteArticoloFromJoinTable(idArticolo);
	...
	public void aggiungiCategoria(Articolo articoloInstance, Categoria categoriaInstance) throws Exception {
		...
		try {
			...
			// attenzione che appInstance deve essere già presente (lo verifica dall'id)
	...
	@Override
	public List<Articolo> voglioArticoliDiOrdineConErroriDate() throws Exception {
		// questo è come una connection
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
		...
		try {
			...
			// eseguo quello che realmente devo fare
			return articoloDAO.findAllArticoliOfOrderWithWrongDates();
